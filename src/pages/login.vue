...
import logosdevDark from "@images/morant/01. OriginalLight.png";
import logosdevLighk from "@images/morant/02. NegativoDark.png";
    ...
    if (res.permisos[0].vista === "Todas") {
      ...
      permisosMenu = menuOpciones.filter((option) => {
        if (tipoUser !== 1 && option.title === "Catalogos") {
          option.children = option.children.filter(
            (menuHijos) => menuHijos.title !== "Configuraciones"
          );
        }
  ...
  try {
    ...
    await nextTick(async () => {
      if (useCookie("tipoUsuario").value == "1") {
        if (
          useCookie("idTipoPermiso").value == 2 ||
          useCookie("idTipoPermiso").value == 3
        ) {
      ...
      <div class="position-relative bg-background rounded-lg w-100 ma-8 me-0">
        <div class="d-flex align-center justify-center w-100 h-100">
          <VImg
            ...
            max-width="500"
            :src="imagenlogin"
            class="auth-illustration mt-4 mb-2"
          />
        </div>
      </div>
    </VCol>
      ...
      <VCard flat :max-width="500" class="mt-12 mt-sm-0 pa-4">
        <VCardText>
          ...
          <h4 class="text-h4 mb-1">
            Bienvenidos a
            <span class="text-capitalize text-morver">
            ...
            <VRow>
              ...
              <VCol cols="12">
                <AppTextField
                  ...
                  placeholder="Introduce tu correo electrónico o nombre de usuario"
                  type="text"
                  autofocus
              ...
              <VCol cols="12">
                ...
                <VBtn block type="submit" color="#848484">
                  Iniciar Sesión
                </VBtn>
              </VCol>
