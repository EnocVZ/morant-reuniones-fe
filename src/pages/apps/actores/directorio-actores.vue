    ...
    methods: {
        ...
        async Guardar() {
            if (this.actor.id == 0) {
                ...
                let result = await directorioactoresService.updateActor(this.actor);
        ...
        async _eliminar() {
            let result = await directorioactoresService.deleteActor(this.idEliminar);
...
<template>
    <div>
        ...
        <p class="text-2xl mc-6">
            <VIcon icon="tabler-user" color="primary" class="me-3" size="30" />Lista de actores
        </p>
        <VRow>
            <VCol cols="12" md="4">
          ...
          <VCard>
            ...
            <VCol cols="12" md="12">
                <VCard>
                    <VCardItem>
                        <VDataTable :headers="headers" :items="DirectorioActores" :search="search">
    ...
    <VDialog v-model="open" max-width="500px">
        <VCard>
            <VCardTitle class="pa-6">
                <span class="headline">{{
                    actor.id != 0 ? "Editar actor" : "Agregar actor"
                }}</span>
            </VCardTitle>
            <VCardText class="pt-0 pb-0">
                <VForm ref="refFormulario" @submit.prevent="() => {
                    ...
                    <VRow>
                        <VCol cols="12" md="12">
                            <VTextField v-model="actor.nombre" label="Nombre (s)" validate-on="input"
                        ...
                        <VCol cols="12" md="12">
                            <VTextField v-model="actor.cargo" label="Cargo" validate-on="input"
                                :rules="[requiredValidator]" />
                        </VCol>
    ...
    <VDialog v-model="modalEliminar" max-width="500px">
        <VCard>
            ...
            <VCardActions>
                ...
                <VBtn color="success" variant="elevated" @click="this._eliminar()">
                    Aceptar
                </VBtn>
