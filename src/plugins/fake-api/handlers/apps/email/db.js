  ...
  emails: [
    {
      ...
      subject: 'Reportan un deslizamiento de tierra en el KM 38.5 de la Carretera Federal 15,',
      cc: [],
      bcc: [],
      message: '<p>Reportan un deslizamiento de tierra en el KM 38.5 de la Carretera Federal 15, hay cierre temporal de la vía dirección CDMX. Se requiere asistencia inmediata para garantizar la seguridad de los conductores y residentes locales. Se pide equipo de limpieza, Protección Civil y Guardia Nacional.</p>',
      attachments: [
    ...
    // },
    {
      ...
      subject: 'Urgencia Media - Ecatepec - 16:20 08/12/2023',
      cc: [],
      bcc: [],
      message: '<p>Urgencia Media - Ecatepec - 16:20 08/12/2023 - Estamos experimentando un fallo eléctrico en la zona residencial de Ecatepec. Aunque no es una emergencia crítica, esto ha dejado a muchos hogares sin suministro de energía eléctrica. Necesitamos asistencia para restablecer la electricidad lo antes posible y garantizar la comodidad y seguridad de nuestros residentes.</p>',
      attachments: [],
      isStarred: false,
    ...
    },
    {
      id: 42,
      to: [{ email: 'johndoe@mail.com', name: 'me' }],
      from: { email: 'adkinsryan@yahoo.com', name: 'Nombre completo', avatar: avatar6 },
      subject: 'Urgencia Alta - Ocoyoacac - 09:55 10/12/2023',
      cc: [],
      bcc: [],
      message: '<p>Urgencia Alta - Ocoyoacac - 09:55 10/12/2023 - Se reporta un deslizamiento de tierra en el KM 38.5 de la Carretera Federal 15, hay cierre temporal de la vía dirección CDMX. Se requiere asistencia inmediata para garantizar la seguridad de los conductores y residentes locales. Se pide equipo de limpieza, Protección Civil y Guardia Nacional.</p>',
      attachments: [],
      isStarred: false,
      labels: ['personal'],
    ...
    },
    {
      id: 41,
      to: [{ email: 'johndoe@mail.com', name: 'me' }],
      from: { email: 'correo@hotmail.com', name: 'nombre completo', avatar: avatar3 },
      subject: 'Urgencia Alta - Ocoyoacac - 09:55 10/12/2023.',
      cc: [],
      bcc: [],
      message: '<p>Urgencia Alta - Ocoyoacac - 09:55 10/12/2023 - Se reporta un deslizamiento de tierra en el KM 38.5 de la Carretera Federal 15, hay cierre temporal de la vía dirección CDMX. Se requiere asistencia inmediata para garantizar la seguridad de los conductores y residentes locales. Se pide equipo de limpieza, Protección Civil y Guardia Nacional.</p>',
    ...
    // },
    {
      id: 37,
      to: [{ email: 'johndoe@mail.com', name: 'me' }],
      from: { email: 'correo@hotmail.com', name: 'nombre', avatar: avatar6 },
      subject: 'Movie admit final enjoy particular.',
      cc: [],
      bcc: [],
      message: '<p>Urgencia Baja - Naucalpan - 08:17 09/12/2023 - Solicitamos una inspección rutinaria de los semáforos en Naucalpan. Si bien no enfrentamos una situación urgente, es esencial asegurarnos de que estos dispositivos funcionen correctamente para mantener el flujo de tráfico seguro y eficiente en nuestro municipio.</p>',
      attachments: [],
      isStarred: false,
      labels: ['important'],
    ...
    },
    {
      id: 24,
      to: [{ email: 'johndoe@mail.com', name: 'me' }],
      from: { email: 'hmoran@gmail.com', name: 'nombre completo', avatar: avatar1 },
      subject: 'Urgencia Media - Toluca - 13:25 08/12/2023.',
      cc: [],
      bcc: [],
      message: '<p>Urgencia Media - Toluca - 13:25 08/12/2023 - Hacemos una solicitud para la reparación de baches en varias calles de Toluca. A pesar de ser de baja urgencia, estos baches han estado causando problemas de tráfico y daños a los vehículos de los residentes. Solicitamos una pronta acción para mejorar la calidad de nuestras carreteras y garantizar la seguridad de los conductores.</p>',
      attachments: [],
      isStarred: false,
      labels: ['company', 'important'],
    ...
    },
    {
      ...
      subject: 'rgencia Media - Ecatepec - 16:20 08/12/2023',
      cc: [],
      bcc: [],
      message: '<p>Urgencia Media - Ecatepec - 16:20 08/12/2023 - Estamos experimentando un fallo eléctrico en la zona residencial de Ecatepec. Aunque no es una emergencia crítica, esto ha dejado a muchos hogares sin suministro de energía eléctrica. Necesitamos asistencia para restablecer la electricidad lo antes posible y garantizar la comodidad y seguridad de nuestros residentes.</p>',
      attachments: [],
    ...
    },
    {
      id: 1,
      to: [{ email: 'johndoe@mail.com', name: 'me' }],
      from: { email: 'edavid@yahoo.com', name: 'NOMBRE', avatar: avatar2 },
